...
class theme_claseWidgets {
    ...
    /**
     * Modifica el código de apertura de un widget para permitir
     * usar un nombre de clase incremental (widget-1, widget-2, etc).
     */
    ...
    /**
     * Aplica clases dependiendo de la cantidad de widgets.
